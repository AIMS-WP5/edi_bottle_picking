#ifndef CONSTANT_POSE_H_
#define CONSTANT_POSE_H_
...
namespace constant_pose
{
	...
	public:
		ConstantPose()
		{
			...
			node_ = std::make_shared<rclcpp::Node>("constant_pose_node", node_options);
