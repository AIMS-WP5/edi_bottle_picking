#ifndef CONVEYOR_FEEDING_H_
#define CONVEYOR_FEEDING_H_
...
namespace conveyor_feeding
{
	class ConveyorFeeding
	{
	public:
		ConveyorFeeding()
		{
			...
			node_ = std::make_shared<rclcpp::Node>("conveyor_feeding_node", node_options);
